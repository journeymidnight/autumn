...
- **Notes:** Go: headRatio=0.3, compactRatio=0.5, periodic 10-20s. Major compaction triggered by split to clear overlap. Depends on F036+F028.
- **passes:** false
...
- **Notes:** Rust has KeyMeta/ValueLoc (F027) but no actual value log stream write path. vhead tracks committed log tail for replay.
- **passes:** false
