...
import (
	...
	"github.com/journeymidnight/autumn/utils/sets"
)
...
//
// The guarantees of th`read safety provided by List/Get are only valid if the caller
...
type threadSafeMap struct {
	...
	//map[IndexName][IndexedValue]Set.String
	//IndexName is analogous to the column Name in SQL
	//IndexedValue is the value of the column to be indexed in SQL
	indices Indices
}
