...
type MaintenanceRequest struct {
	...
	MajorCompact bool   `protobuf:"varint,3,opt,name=majorCompact,proto3" json:"majorCompact,omitempty"`
}
...
func (m *MaintenanceRequest) GetGc() bool {
	if m != nil {
		return m.Gc
	}
	return false
...
func (m *MaintenanceRequest) GetMajorCompact() bool {
	if m != nil {
		return m.MajorCompact
	}
	return false
}
...
var fileDescriptor_3e3c719c85d382a4 = []byte{
	...
	,
}
...
func (m *MaintenanceRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MajorCompact", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
